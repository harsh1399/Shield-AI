...
def troops_positions(file_path = "Data/configuration_file.json"):
    troops_position = []
    with open(file_path) as f:
        data = json.load(f)
        troops = ['shooters','tanks','helicopters']
        deployment_positions = data["deployment"]
        ...
        for troop in troops:
            deployment = deployment_positions[troop]
            value = 0
            for key in deployment.keys():
                if isinstance(deployment[key],int):
                    value = deployment[key]
                else:
                    for i in range(value):
                        x, y = 0, 0
                        if deployment[key] == "top right":
                            x = random.randint(700, 1000)
                            y = random.randint(50, 95)
                        elif deployment[key] == "center top":
                            x = random.randint(400, 699)
                            y = random.randint(50, 95)
                        elif deployment[key] == "top left":
                            x = random.randint(100, 399)
                            y = random.randint(50, 95)
                        elif deployment[key]== "center right":
                            x = random.randint(1030, 1050)
                            y = random.randint(271, 440)
                        elif deployment[key] == "center left":
                            x = random.randint(10, 50)
                            y = random.randint(271, 440)
                        elif deployment[key] == "bottom right":
                            x = random.randint(700, 1000)
                            y = random.randint(615, 640)
                        elif deployment[key] == "center bottom":
                            x = random.randint(400, 699)
                            y = random.randint(615, 640)
                        elif deployment[key] == "bottom left":
                            x = random.randint(100, 399)
                            y = random.randint(615, 640)
...
if __name__ == "__main__":
    shooters_behavior,tanks_behavior,helicopters_behavior = create_map_from_configuration("Data/configuration_file.json")
